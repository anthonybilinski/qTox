...
protected:
    ...
    Widget* parent;
    std::shared_ptr<const QString> stylesheetButton;
    std::shared_ptr<const QString> stylesheetMsgEdit;
    std::shared_ptr<const QString> stylesheetChatArea;
    std::shared_ptr<const QString> stylesheetChatHead;
