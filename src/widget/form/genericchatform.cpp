...
QPushButton* createButton(const QString& name, T* self, Fun onClickSlot, const QString& stylesheet)
{
...
void GenericChatForm::onChatMessageFontChanged(const QFont& font)
{
    ...
    // message editor
    std::shared_ptr<const QString> newStyle = Style::getStylesheet(":/ui/msgEdit/msgEdit.css");
